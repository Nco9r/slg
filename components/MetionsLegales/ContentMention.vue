    ...
    <div class="content_mentions">
      ...
      <div class="block_content">
        ...
        <p>
          ...
          du site www.slgrealisation.fr l’identité des différents intervenants
          dans le cadre de sa réalisation et de son suivi :
        </p>

        <p>
          <strong>Propriétaire :</strong> SLGrealisation - 95 avenue du Maréchal
          de Lattre de Tassigny 33610, Cestas
        </p>

        <p><strong>Responsable publication :</strong> SLGrealisation</p>
        <p>
          <strong>Hébergeur :</strong> O2 Switch – 222 Boulevard Gustave
          Flaubert – 63000 Clermont-Ferrand – France.
        </p>
        <p>
          <strong>Développement et Webdesign :</strong>
          <a href="https://rouxnicolas.fr">ROUX Nicolas</a>
        </p>
      </div>
      <div class="block_content">
        <h3>
        ...
        <p>
          L’utilisation du site www.slgrealisation.fr implique l’acceptation
          ...
          www.slgrealisation.fr sont donc invités à les consulter de manière
          régulière.
        </p>
        <p>
          ...
          décidée par SLGrealisation qui s’efforcera alors de communiquer
          préalablement aux utilisateurs les dates et heures de l’intervention.
        </p>
        <p>
          Le site www.slgrealisation.fr est mis à jour régulièrement par Nicolas
          ROUX. De la même façon, les mentions légales peuvent être modifiées à
      ...
      <div class="block_content">
        ...
        <p>
          Le site www.slgrealisation.fr a pour objet de fournir une information
          concernant l’ensemble des activités de la société.
        </p>
        <p>
          SLGrealisation s’efforce de fournir des informations aussi précises
          que possible sur le www.slgrealisation.fr . Toutefois, il ne pourra
        ...
        <p>
          Tous les informations indiquées sur le site www.slgrealisation.fr sont
          données à titre indicatif, et sont susceptibles d’évoluer. Par
          ailleurs, les renseignements figurant sur le site
          www.slgrealisation.fr ne sont pas exhaustifs. Ils sont donnés sous
      ...
      <div class="block_content">
        ...
        <p>
          SLGrealisation est propriétaire des droits de propriété intellectuelle
      ...
      <div class="block_content">
        ...
        <p>
          SLGrealisation ne pourra être tenue responsable des dommages directs
          et indirects causés au matériel de l’utilisateur, lors de l’accès au
          site www.slgrealisation.fr, et résultant soit de l’utilisation d’un
          matériel ne répondant pas aux spécifications indiquées au point 4,
          soit de l’apparition d’un bug ou d’une incompatibilité.
        </p>
        <p>
          SLGrealisation ne pourra également être tenue responsable des dommages
          indirects (tels par exemple qu’une perte de marché ou perte d’une
          chance) consécutifs à l’utilisation du site www.slgrealisation.fr.
        </p>
        <p>
          Des espaces interactifs (possibilité de poser des questions dans
          l’espace contact) sont à la disposition des utilisateurs.
          SLGrealisation se réserve le droit de supprimer, sans mise en demeure
          ...
          relatives à la protection des données. Le cas échéant, SLGrealisation
      ...
      <div class="block_content">
        ...
        <p>
          A l’occasion de l’utilisation du site www.slgrealisation.fr, peuvent
          êtres recueillies : l’URL des liens par l’intermédiaire desquels
          l’utilisateur a accédé au site www.slgrealisation.fr, le fournisseur
          d’accès de l’utilisateur, l’adresse de protocole Internet (IP) de
          l’utilisateur.
        </p>
        <p>
          En tout état de cause SLGrealisation ne collecte des informations
          personnelles relatives à l’utilisateur que pour le besoin de certains
          services proposés par le site www.slgrealisation.fr. L’utilisateur
          ...
          l’utilisateur du site www.slgrealisation.fr l’obligation ou non de
        ...
        <p>
          ...
          www.slgrealisation.fr n’est publiée à l’insu de l’utilisateur,
          échangée, transférée, cédée ou vendue sur un support quelconque à des
          tiers. Seule l’hypothèse du rachat de SLGrealisation et de ses droits
      ...
      <div class="block_content">
        ...
        <p>
          Le site www.slgrealisation.fr contient un certain nombre de liens
          hypertextes vers d’autres sites, mis en place avec l’autorisation de
          SLGrealisation. Cependant, SLGrealisation n’a pas la possibilité de
          vérifier le contenu des sites ainsi visités, et n’assumera en
          conséquence aucune responsabilité de ce fait.
        </p>
        <p>
          La navigation sur le site www.slgrealisation.fr est susceptible de
      ...
      <div class="block_content">
        ...
        <p>
          ...
          www.slgrealisation.fr est soumis au droit français. Il est fait
